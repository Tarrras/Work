...
public class ViewedActivity extends Activity {
    RecyclerView recycleView;
    LinearLayoutManager layoutManager;
    final String LOG_TAG="myLog";
    List<Result> mostViewed;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter=new ListAdapter(mostViewed);
        ...
        Builder.getApiMost().mostViewed().enqueue(new Callback<Example>() {
            @Override
            public void onResponse(Call<Example> call, Response<Example> response) {
                if (response.isSuccessful()){
                    ...
                    mostViewed=response.body().getResults();
